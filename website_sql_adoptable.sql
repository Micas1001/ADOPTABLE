...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13-Maio-2025 às 16:32
...
(11, 1, 'Dino', 'cão', 'Bulldog', 'Macho', 'Jovem', 'Braga', 'animais/jLW5FRQq950Yya2H1i8SHGn2fSdMP4V5ZldICigD.jpg', '2025-05-13 13:17:14', '2025-05-13 13:17:14'),
(12, 1, 'Lord', 'cão', 'Cane Corso', 'Macho', 'Jovem', 'Leiria', 'animais/vhq2rCwZpBbkt2enTiWu2TkYr79FewkHxFVtYBnS.jpg', '2025-05-13 13:24:46', '2025-05-13 13:24:46');
...
INSERT INTO `comments` (`id`, `user_id`, `animal_id`, `comentario`, `avaliacao`, `created_at`, `updated_at`) VALUES
(2, 1, 3, 'Adorei o processo de adoção e acompanhamento do meu novo cão.', 5, '2025-05-07 13:46:07', '2025-05-07 13:46:07'),
(3, 1, 4, 'Luna muito fixe!!', 5, '2025-05-11 17:38:31', '2025-05-11 17:38:31'),
(4, 1, 2, 'TOP', 4, '2025-05-11 17:51:28', '2025-05-11 17:51:28'),
(5, 1, 6, 'Serra da Estrela!!!', 5, '2025-05-13 13:02:01', '2025-05-13 13:02:01');
...
(13, '2025_05_07_142518_create_comments_table', 8);
...
('qUk70JRHirYmiwI9zEhFpBn4GWE5Ly0tLOstcXva', 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/136.0.0.0 Safari/537.36', '', 1747146689);
...
ALTER TABLE `comments`
  ...
  ADD KEY `comments_animal_id_foreign` (`animal_id`);
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_animal_id_foreign` FOREIGN KEY (`animal_id`) REFERENCES `animals` (`id`) ON DELETE CASCADE,
