...
<nav class="navbar navbar-expand-lg bg-white shadow-sm">
  <div class="container-fluid">
    ...
    <a class="navbar-brand d-flex align-items-center" href="#">
      <img src="/imgs/logo.png" alt="Logo" width="124" height="36" class="d-inline-block align-text-top">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav"> <!-- Centraliza os itens do menu -->
        <li class="nav-item px-3">
          <a class="nav-link" onMouseOver="this.style.color='#FE5101'" onMouseOut="this.style.color=''" href="#">Gatos</a>
        </li>
        <li class="nav-item px-3">
      ...
      <div class="d-flex ms-auto align-items-center">
        <button class="btn me-2 p-2" style="border: 1px solid #D9D9D9;">Login</button>
        <button class="btn p-2 text-white" style="background-color:#FE5101;">Criar conta</button>
      </div>
    </div>
  </div>
</nav>
  ...
  <section class="hero text-center text-lg-start">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <img src="/imgs/Star-2.jpg.webp" alt="Mulher com cachorro" class="img-fluid rounded">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div id="carouselDogs" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="/imgs/img1.webp" class="d-block w-100 rounded" alt="Cachorro sendo acariciado">
                            </div>
                            <div class="carousel-item">
                                <img src="/imgs/img2.webp" class="d-block w-100 rounded" alt="Outro cachorro feliz">
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    <img src="/imgs/logo.png" alt="Adoptable Logo" width="130">
                </div>
