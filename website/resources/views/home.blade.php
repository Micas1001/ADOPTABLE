        ...
        <form class="row g-2" method="GET" action="{{ route('animais.index') }}">
            ...
            <div class="col-md-2">
                <select class="form-select" name="localizacao">
                    ...
                    <option value="Coimbra" {{ request('localizacao') == 'Coimbra' ? 'selected' : '' }}>Coimbra</option>
                    <option value="Lisboa" {{ request('localizacao') == 'Lisboa' ? 'selected' : '' }}>Lisboa</option>
                    <option value="Porto" {{ request('localizacao') == 'Porto' ? 'selected' : '' }}>Porto</option>
                </select>
            </div>
            <div class="col-md-2">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.2s;">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            @else
                                <button type="button" class="wishlist-btn text-danger" data-bs-toggle="modal" data-bs-target="#loginModal" title="Favoritos">
                                    💖
                                </button>
                            @endauth
                            </div>
